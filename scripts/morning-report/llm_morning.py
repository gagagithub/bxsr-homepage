...
这份晨报**早上 7 点多发出**，读者是刚起床/上班路上打开看的，讲的是**昨天白天到今天早上这段时间发生的事**(A股昨天已收盘，美股隔夜刚收盘，今天A股还没开盘)。
所以时间措辞要按事情**真实发生的时点**写：国内白天的事写"昨天/昨天下午/昨天收盘"，美股外盘写"昨夜/隔夜"，刚出的消息写"今天早上/今早"。**绝对不要把昨天发生的事写成"今天"，更不要写"今天收盘/今天上午"**——今天股市还没开，这么写读者一眼就看出是错的。
...
【文风铁律：说人话，别播新闻联播】
- 像一位懂行的老朋友一早泡上茶跟你唠昨天到今早的新闻，通篇口语化短句，一句话尽量不超过30字。
...
{{""")
    ...
    if want_meta:
        ...
        reqs.append("- ⚠lead.relate 结尾那句【值得转发给家人的记忆点】务必写足写好——它是这篇能不能被转发的唯一钩子(晨报当前分享量近乎为零)，宁可朴实好懂，也别写空泛口号。")
