...
{{""")
    ...
    if want_tail:
        parts.append('''  "insure": [
    {"ic":"🌅","tt":"养老","tx":"挑当天跟养老钱最相关的新闻(利率/降息/养老金/人口…)，先点是哪条，再往读者爱看的角度靠:'数字倒推(每月想领1万得备多少本金)''利率下行、锁长期利率的窗口'。讲清对正给自己备养老钱的人意味着什么。别只搬宏观、别干喊买存款国债。100-150字，<b>关键短语加粗</b>"},
    {"ic":"🌳","tt":"传承","tx":"挑当天跟家庭财富保值/传承相关的新闻(汇率/黄金/资产价格/楼市…)，往'钱怕被离婚分走怎么隔离''过户vs遗嘱vs保单受益人''想给钱又不想现在给'这类场景上靠。讲清对有几套房、想稳稳传下去的家庭意味着什么。别炒遗产税。100-150字"},
    {"ic":"💵","tt":"钱袋子","tx":"从当天宏观/利率/汇率/股市新闻出发，用他们的共同语言(股票、基金人人在买)切入，讲对家庭资产配置的参考，落到确定性/稳健的视角。100-150字"},
    {"ic":"🏥","tt":"健康","tx":"仅当天确有医疗/医保/药品/健康产业新闻时才给。往'进口药能报多少''带病/结节三高怎么核保''50岁后重疾太贵怎么替代'这类角度靠，讲清跟看病住院的关系。没有相关新闻就整条省略"}
  ]''')
        parts.append('''  "review": {
