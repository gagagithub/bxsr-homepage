...
TOPICS = [
    ...
    ("物价开销", "①统计局公布的 CPI 与食品价格(菜价、肉价、蛋价、粮油)变化;\n"
               "②水、电、燃气、供暖、自来水的价格或收费标准调整;\n"
               "③公交地铁票价、话费宽带资费的调整; ④米面粮油等生活必需品的价格波动。\n"
               "都要是普通家庭每月实际要掏的钱, 不要讲期货、大宗商品和行业分析。"),
    ("异地就医", "①异地就医备案与直接结算的新规(备案怎么办、能报多少、哪些医院能刷);\n"
               "②门诊统筹与门诊慢特病跨省结算的进展; ③随子女异地养老、长期驻外人员的医保待遇;\n"
               "④医保关系转移接续、跨省通办的新举措。"),
    ("老年优待", "①高龄津贴、老年人补贴的发放标准与调整; ②敬老卡/老年证的办理与免费乘车、景区门票优待;\n"
               "③老年人交通、通信、水电燃气等方面的优惠政策; ④面向老年人的免费体检、免费接种等公共服务。"),
    ("遗属待遇", "①遗属待遇(丧葬补助金、抚恤金)的标准、发放与新规;\n"
               "②供养亲属抚恤金的计发办法; ③退休人员去世后养老金个人账户余额继承的规定与办理流程。\n"
               "这是很多家庭遇到才知道去问的事, 讲清楚能领什么、找谁办、要什么材料。"),
]
